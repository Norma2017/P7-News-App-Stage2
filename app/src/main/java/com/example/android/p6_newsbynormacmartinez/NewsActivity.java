...
public class NewsActivity extends AppCompatActivity {
     ...
     * Guardian API key
     */
    private static  final  String API_KEY = "4075f0b5-fb4a-4560-9c8d-98a2bc5c9a0d";
    ...
    private final LoaderCallbacks<List<News>> newsLoader
        ...
        // onCreateLoader instantiates and returns a news loader for the given ID
        ...
        public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
            ...
            if(searchPharse != "") {
                uriBuilder.appendQueryParameter(getString(R.string.q), searchPharse);
            }
            ...
            uriBuilder.appendQueryParameter(getString(R.string.api_key), API_KEY);
